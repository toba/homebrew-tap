class XcMcp < Formula
  ...
  url "https://github.com/toba/xc-mcp/releases/download/v1.62.0/xc-mcp-v1.62.0-arm64.tar.gz"
  version "1.62.0"
  sha256 "f55e2e4b07e7a2a56ce703fcdf4b4e6eb21a88a208c91719ed50f3ba2e7de7c4"
  license "MIT"
