class Sm < Formula
  ...
  url "https://github.com/toba/swiftiomatic/releases/download/v3.0.6/sm-v3.0.6-arm64.tar.gz"
  version "3.0.6"
  sha256 "c301ad12d8b0a88922944f43ad02e84fd73b35474ff978b6a4a4a7a06ff8d6a1"
  license "MIT"
