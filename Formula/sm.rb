class Sm < Formula
  ...
  url "https://github.com/toba/swiftiomatic/releases/download/v3.0.4/sm-v3.0.4-arm64.tar.gz"
  version "3.0.4"
  sha256 "e2b5a5ee1d6eea182a0515654140a43fdc366b6f392fc5d396044372badb303f"
  license "MIT"
