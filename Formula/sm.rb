class Sm < Formula
  ...
  url "https://github.com/toba/swiftiomatic/releases/download/v3.3.0/sm-v3.3.0-arm64.tar.gz"
  version "3.3.0"
  sha256 "ab7062f68c4bf6e5ca167b34881255316f05a80b6d8d6d2b9fc156828b6e7905"
  license "MIT"
